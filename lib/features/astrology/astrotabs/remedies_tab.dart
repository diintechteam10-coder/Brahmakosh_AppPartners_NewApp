...
class RemediesTab extends StatelessWidget {
  final GemstoneRemedies? gemstoneSuggestion;
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildGemstoneCard(
            "Benefic Stone",
            gemstoneSuggestion!.beneficStone,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          _buildDetailRow("Gemstone", detail.gemstone ?? "-", isBold: true),
          if (detail.substitute != null && detail.substitute!.isNotEmpty)
            _buildDetailRow("Substitute", detail.substitute ?? "-"),
          _buildDetailRow("Weight", detail.weight ?? "-"),
          _buildDetailRow("Wear Finger", detail.wearFinger ?? "-"),
          _buildDetailRow("Metal", detail.metal ?? "-"),
          _buildDetailRow("Day", detail.day ?? "-"),
        ],
      ),
    );
  }
