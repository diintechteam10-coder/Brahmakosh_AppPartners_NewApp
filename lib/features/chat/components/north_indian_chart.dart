...
class NorthIndianChart extends StatelessWidget {
  ...
  String _generateSvg(int ascNum) {
    ...
    void addPlanetText(
      ...
      if (isLarge) {
        int score = int.tryParse(text) ?? 0;
        String color = "#333333";
        if (score > 28)
          color = "#1b8337"; // Greenish
        else if (score < 25)
          color = "#c73c3f"; // Reddish

        planetsSvg.writeln(
          '<text font-size="22" x="$x" y="$y" fill="$color" font-weight="bold" text-anchor="middle" alignment-baseline="middle">$text</text>',
        );
      } else {
        planetsSvg.writeln(
          '<text font-size="12" x="$x" y="$y" fill="#DE8E0C" font-weight="bold" text-anchor="middle" alignment-baseline="middle">$text</text>',
        );
      }
    }
    ...
    for (int i = 0; i < 12; i++) {
      ...
      if (planets.isNotEmpty) {
        ...
        if (isSarvashtak) {
          addPlanetText(planets.first, zoneX, zoneY, isLarge: true);
        } else {
          // Logic for wrapping if too many planets
          // Max 2-3 per line
          int maxPerLine = 3;
          if (i == 2 || i == 4 || i == 8 || i == 10)
            maxPerLine = 2; // Narrower triangles
          ...
          for (int l = 0; l < lines.length; l++) {
            ...
            String lineStr = linePlanets
                .map((p) => _getPlanetCode(p))
                .join(" ");
    ...
    for (int i = 0; i < 12; i++) {
      ...
      signsSvg.writeln(
        '<text font-size="15" x="$x" y="$y" fill="#75879A">$sign</text>',
      );
    }
...
<svg width="350" height="350" viewBox="0 0 350 350" xmlns="http://www.w3.org/2000/svg">
  <g class="slice">
    <!-- Paths -->
    <path d="M10,10L175,10L92.5,92.5L10,10" stroke="#E3940E" stroke-width="1.5" fill="none"/>
    <path d="M175,10L340,10L257.5,92.5L175,10" stroke="#E3940E" stroke-width="1.5" fill="none"/>
    <path d="M92.5,92.5L10,175L10,10" stroke="#E3940E" stroke-width="1.5" fill="none"/>
    <path d="M92.5,92.5L175,175L257.5,92.5L175,10" stroke="#E3940E" stroke-width="1.5" fill="none"/>
    <path d="M257.5,92.5L340,175L340,10" stroke="#E3940E" stroke-width="1.5" fill="none"/>

    <path d="M92.5,92.5L175,175L92.5,257.5L10,175" stroke="#E3940E" stroke-width="1.5" fill="none"/>
    <path d="M257.5,92.5L340,175L257.5,257.5L175,175" stroke="#E3940E" stroke-width="1.5" fill="none"/>

    <path d="M92.5,257.5L10,340L10,175" stroke="#E3940E" stroke-width="1.5" fill="none"/>
    <path d="M175,175L257.5,257.5L175,340L92.5,257.5" stroke="#E3940E" stroke-width="1.5" fill="none"/>
    <path d="M340,175L340,340L257.5,257.5" stroke="#E3940E" stroke-width="1.5" fill="none"/>

    <path d="M92.5,257.5L175,340L10,340" stroke="#E3940E" stroke-width="1.5" fill="none"/>
    <path d="M257.5,257.5L340,340L175,340" stroke="#E3940E" stroke-width="1.5" fill="none"/>
