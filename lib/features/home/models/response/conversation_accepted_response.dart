class ConversationAcceptedResponse {
  final bool success;
  ...
  factory ConversationAcceptedResponse.fromJson(Map<String, dynamic> json) {
...
class ConversationData {
  ...
  factory ConversationData.fromJson(Map<String, dynamic> json) {
    return ConversationData(
      ...
      unreadCount: UnreadCount.fromJson(json['unreadCount']),
    );
  }
}
class Partner {
...
class Rating {
  ...
  factory Rating.fromJson(Map<String, dynamic> json) {
    return Rating(
      byUser: RatingInfo.fromJson(json['byUser']),
      byPartner: RatingInfo.fromJson(json['byPartner']),
    );
  }
}
